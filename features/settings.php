			...
			update_option('directory_url', $_POST['directory_url']);
				if(get_page_by_path('department-directory') == NULL){
					...
					foreach($xml->employee as $emp){
						...
						if ($emp->hasPhoto == "yes"){
							$directoryOutput = $directoryOutput . "<img src='https://photosapi.central.edu/photos/fac/?name=" . $emp->username . "' alt='" . $emp->firstName . " " . $emp->lastName. "' style='float:right; padding: 1px; margin: 1px; border: 1px solid #ccc;'/>";
						}
